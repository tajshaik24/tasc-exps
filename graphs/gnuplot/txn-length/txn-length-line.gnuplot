...
set output "txn-length-line.eps"
...
plot 'txn-length.data' using 1:2 title "Aft-D (Median)" with linespoints lt 16 lw 4.5 pt 2 ps 1.5, \
                    43 * x title 'Aft-D Linear' with lines dt "." lt 16 lw 3.5, \
